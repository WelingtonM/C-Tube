            ...
            <div class="card text-white bg-secondary">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @if($channel->editable())
                            <input onchange="document.getElementById('update-channel-form').submit()" id="image" type="file" name="image" style="display: none;">
                    ...
                    <table class="table table-striped table-dark">
                        ...
                        <tbody>
                            @foreach($videos as $video)
                                <tr>
                                    <td><img src="{{ $video->thumbnail }}" width="40px" height="40px"></td>
                                    <td>{{ $video->title }}</td>
                                    <td>{{ $video->views }}</td>
